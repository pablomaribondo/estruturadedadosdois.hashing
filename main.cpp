...
int main(int argc, char *argv[]) {
    ...
    cout << "Time taken to insert 10000 elements: " << EE_Insert_duration.count() << " microseconds" << endl;
    /** Remove*/
    ...
    cout << "Time taken to remove 3000 elements: " << EE_Remove_duration.count() << " microseconds" << endl;
    /** Query*/
    ...
    cout << "Time taken to query 100000 elements: " << EE_Find_duration.count() << " microseconds" << endl;
    ...
    cout << "Time taken to insert 10000 elements: " << EI_Insert_duration.count() << " microseconds" << endl;
    /** Remove*/
    ...
    cout << "Time taken to remove 3000 elements: " << EI_Remove_duration.count() << " microseconds" << endl;
    /** Query*/
    ...
    cout << "Time taken to query 100000 elements: " << EI_Find_duration.count() << " microseconds" << endl;
    ...
    cout << "Time taken to insert 10000 elements: " << TL_Insert_duration.count() << " microseconds" << endl;
    /** Remove*/
    ...
    cout << "Time taken to remove 3000 elements: " << TL_Remove_duration.count() << " microseconds" << endl;
    /** Query*/
    ...
    cout << "Time taken to query 100000 elements: " << TL_Find_duration.count() << " microseconds" << endl;
    ...
    cout << "Time taken to insert 10000 elements: " << HD_Insert_duration.count() << " microseconds" << endl;
    /** Remove*/
    ...
    cout << "Time taken to remove 3000 elements: " << HD_Remove_duration.count() << " microseconds" << endl;
    /** Query*/
    ...
    cout << "Time taken to query 100000 elements: " << HD_Find_duration.count() << " microseconds" << endl;
